...
def local_table_maker(file_path):
    ...
    required_columns = ['School Code', 'Academic Year', 'Total CS Enrollment']
...
def create_table_files():
    ...
    for file_path in file_paths_in_folder():
        ...
        directory_path = r'C:\Users\cmaw3\Desktop\WI_CS_Dashboard_24\VisualizationData\EnrollmentInfo\EnrollmentCount'
